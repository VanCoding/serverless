...
let
  sources = {
    ...
    "@serverless/core-1.1.1" = {
      ...
      version = "1.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@serverless/core/-/core-1.1.1.tgz";
        sha512 = "jzsIwn9u9bZa+oDpIzivGOi+/Iv16wD/vM0J2yDuit1xa5efINQ+EkyrkDvrwE9y6znO5m1HAv7TYA/aNWVxpw==";
      };
    };
    "@serverless/enterprise-plugin-3.1.1" = {
      name = "_at_serverless_slash_enterprise-plugin";
      packageName = "@serverless/enterprise-plugin";
      version = "3.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@serverless/enterprise-plugin/-/enterprise-plugin-3.1.1.tgz";
        sha512 = "qvthNFPN43zd2zORHC4pWJGynUsFfiJ31/WjKi5VjGOS/BEpNxa5cwyGpewXx+SloK8iPYSGGjtAlYmbZpRagw==";
      };
    };
    ...
    "@types/lodash-4.14.142" = {
      ...
      version = "4.14.142";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/lodash/-/lodash-4.14.142.tgz";
        sha512 = "ZhNS7c4D4WQ49Dr1FftQj7SwngRswOnPfxktmqSy5BettRCuum2q784jRwNTYfxH00r8+fEgRz6Da8j5DHNd1Q==";
      };
    };
    "accepts-1.3.7" = {
      name = "accepts";
    ...
    "aws-sdk-2.544.0" = {
      ...
      version = "2.544.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/aws-sdk/-/aws-sdk-2.544.0.tgz";
        sha512 = "wwiBJgAUGKXY/xoCSrUXVZnNtefoH3YcPwGxQrQXOIDnLMQ32yh/SWc52qmwdxA7WJzpTcIj8y+5keH3P1LYaw==";
      };
    };
    ...
    "nanoid-2.1.2" = {
      ...
      version = "2.1.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/nanoid/-/nanoid-2.1.2.tgz";
        sha512 = "q0iKJHcLc9rZg/qtJ/ioG5s6/5357bqvkYCpqXJxpcyfK7L5us8+uJllZosqPWou7l6E1lY2Qqoq5ce+AMbFuQ==";
      };
    };
    "nanomatch-1.2.13" = {
      name = "nanomatch";
  ...
  args = {
    ...
    dependencies = [
      ...
      (sources."@serverless/core-1.1.1" // {
        dependencies = [
          sources."fs-extra-7.0.1"
          sources."semver-6.3.0"
        ];
      })
      (sources."@serverless/enterprise-plugin-3.1.1" // {
        dependencies = [
          sources."fs-extra-7.0.1"
          sources."node-fetch-2.6.0"
          sources."uuid-3.3.3"
